...
pub unsafe fn setpriv_main(
  ...
  static mut setpriv_longopts: [libc::c_char; 55] = [
    100, 117, 109, 112, 0, 0, 100, 110, 110, 112, 0, 0, 255u8 as libc::c_char, 110, 111, 45, 110, 101, 119, 45, 112,
    114, 105, 118, 115, 0, 0, 255u8 as libc::c_char, 105, 110, 104, 45, 99, 97, 112, 115, 0, 1, 254u8 as libc::c_char, 97, 109, 98, 105,
    101, 110, 116, 45, 99, 97, 112, 115, 0, 1, 253u8 as libc::c_char, 0,
  ];
